...
int main()
{
    ...
    while(Choice != 12)
    {
        ...
        switch(Choice)
        {
            case 1:
            {
                ...
                InputIndex(Index);
                Success = DoubleLinkedList1.InsertAt(Data, Index);
                if(Success)
                {
            ...
            case 2:
            {
                std::cout << "Enter data element: ";
                InputData(Data);
                Success = DoubleLinkedList1.InsertHead(Data);
            ...
            case 3:
            {
                std::cout << "Enter data element: ";
                InputData(Data);
                Success = DoubleLinkedList1.InsertEnd(Data);
            ...
            case 4:
            {
                ...
                InputIndex(Index);
                Success = DoubleLinkedList1.RemoveAt(Index);
                if(Success)
                {
            ...
            case 5:
            {
                Success = DoubleLinkedList1.RemoveHead();
                if(Success)
                {
            ...
            case 6:
            {
                Success = DoubleLinkedList1.RemoveEnd();
                if(Success)
                {
            ...
            case 8:
            {
                ...
                InputIndex(Index);
                Success = DoubleLinkedList1.GetData(Index, d_ptr);
                if(Success)
                {
            ...
            case 9:
            {
                ...
                std::cout << "Enter index on which you want to store the data: ";
                InputIndex(Index);
                Success = DoubleLinkedList1.SetData(Index, Data);
                if(Success)
                {
            ...
            case 10:
            {
                std::cout << "Length of the DoubleLinkedList: ";
                std::cout << DoubleLinkedList1.GetLength() << std::endl;
                std::cin.ignore();
                std::cout << "Press enter to continue...";
                std::cin.get();
                break;
            ...
            case 11:
            {
                Success = DoubleLinkedList1.Empty();
                if(Success)
                {
                    std::cout << "DoubleLinkedList was delete" << std::endl;
                    std::cin.ignore();
                    std::cout << "Press enter to continue...";
                    std::cin.get();
                }
                ...
                {
                    std::cout << "DoubleLinkedList is already empty" << std::endl;
                    std::cin.ignore();
                    std::cout << "Press enter to continue...";
                    std::cin.get();
                }
    ...
    DoubleLinkedList CopyLinkedList(DoubleLinkedList1);
